 ...
 * from https://github.com/sumory/uc/blob/master/src/com/sumory/uc/id/IdWorker.java
 */
@Slf4j
public final class IdUtil {
	...
	private static IdWorker idWorker = new IdWorker(workerId);
	...
	public static long nextId(){
		try {
			...
			throw new RuntimeException("id generate error");
		}
	}
